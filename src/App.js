...
{/* Date on Market */}
                    ...
                    {site.listingUrl ? <a href={site.listingUrl.startsWith("http") ? site.listingUrl : "https://" + site.listingUrl} target="_blank" rel="noopener noreferrer" style={{ padding: "4px 10px", borderRadius: 6, background: "#FFF3E0", color: "#E65100", fontSize: 11, fontWeight: 600, textDecoration: "none" }}>🔗 Property Listing</a> : <a href={"https://www.crexi.com/properties?query=" + encodeURIComponent((site.address || "") + " " + (site.city || "") + " " + (site.state || ""))} target="_blank" rel="noopener noreferrer" style={{ padding: "4px 10px", borderRadius: 6, background: "#FFF8F0", color: "#BF6A02", fontSize: 11, fontWeight: 600, textDecoration: "none" }}>🔍 Find on Crexi</a>}
